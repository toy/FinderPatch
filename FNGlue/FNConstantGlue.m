...
+ (FNConstant *)MacOSExtendedFormat {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"MacOSExtendedFormat" type: typeEnumerated code: 0x6466682b];
    return constantObj;
}
...
+ (FNConstant *)unknownFormat {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"unknownFormat" type: typeEnumerated code: 0x64663f3f];
    return constantObj;
}
...
+ (FNConstant *)largeMonochromeIconAndMask {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"largeMonochromeIconAndMask" type: typeType code: 0x49434e23];
    return constantObj;
}
...
+ (FNConstant *)smallMonochromeIconAndMask {
    static FNConstant *constantObj;
    if (!constantObj)
        constantObj = [FNConstant constantWithName: @"smallMonochromeIconAndMask" type: typeType code: 0x69637323];
    return constantObj;
}
