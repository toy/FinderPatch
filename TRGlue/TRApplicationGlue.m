...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [TRConstant class]
                                           referenceClass: [TRReference class]
...
- (TRReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [TRReference class]])
        return [[[TRReference alloc] initWithAppData: AS_appData
